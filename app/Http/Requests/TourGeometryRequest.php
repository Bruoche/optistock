 ...
 * optional travel mode. No mode selector exists yet — when omitted the server
 * uses the configured default (`trucking`).
 */
class TourGeometryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'mode' => ['sometimes', 'string', 'in:driving,walking,trucking'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'mode.in' => 'Mode must be one of: driving, walking, trucking.',
        ];
    }
}
